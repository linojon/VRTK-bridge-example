...
namespace Valve.VR.InteractionSystem
{
	...
	public class CircularDrive : MonoBehaviour
	{
		...
		[Tooltip( "If limited is true, the specifies the lower limit, otherwise variableValue is unused" )]
		...
		[Tooltip( "If limited is true, the specifies the upper limit, otherwise variableValue is unused" )]
		...
		[Tooltip( "If true, the path of the Hand (red) and the projected variableValue (green) will be drawn" )]
		...
		[Tooltip( "If not null, the TextMesh will display the linear variableValue and the angular variableValue of this circular drive" )]
		public TextMesh debugText = null;

		[Tooltip( "The output angle variableValue of the drive in degrees, unlimited will increase or decrease without bound, take the 360 modulus to find number of rotations" )]
		...
		//-------------------------------------------------
		// Updates the LinearMapping variableValue from the angle
		//-------------------------------------------------
		private void UpdateLinearMapping()
		{
			if ( limited )
			{
				// Map it to a [0, 1] variableValue
		...
		//-------------------------------------------------
		// Updates the Debug TextMesh with the linear mapping variableValue and the angle
		//-------------------------------------------------
